 ...
 */
class PDFMM_API PdfAxialShadingPattern final : public PdfShadingPattern
{
public:
 ...
 */
class PDFMM_API PdfFunctionBaseShadingPattern final : public PdfShadingPattern
{
public:
 ...
 *  shading between two colors.
 */
class PDFMM_API PdfRadialShadingPattern final : public PdfShadingPattern
{
public:
 ...
 */
class PDFMM_API PdfTriangleShadingPattern final : public PdfShadingPattern
{
public:
