...
{
    void InitXml();
    xmlNodePtr FindChildElement(const xmlNodePtr element, const std::string_view& name);
    xmlNodePtr FindChildElement(const xmlNodePtr element, const std::string_view& prefix, const std::string_view& name);
    xmlNodePtr FindSiblingNode(const xmlNodePtr element, const std::string_view& name);
