...
void PdfFontType1::embedFontSubset()
{
    ...
    PDFMM_ASSERT(inBuff[inIndex + 0] == 0x80);
    PDFMM_ASSERT(inBuff[inIndex + 1] == 0x01);
    ...
    PDFMM_ASSERT(memcmp(&inBuff[inIndex], "%!PS-AdobeFont-1.", 17) == 0);
    ...
    PDFMM_ASSERT(inBuff[inIndex + 0] == 0x80);
    PDFMM_ASSERT(inBuff[inIndex + 1] == 0x02);
