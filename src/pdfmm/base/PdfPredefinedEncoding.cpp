...
bool PdfDocEncoding::IsPdfDocEncodingCoincidentToUTF8(const string_view& view)
{
...
string PdfDocEncoding::ConvertUTF8ToPdfDocEncoding(const string_view& view)
{
    string ret;
...
bool PdfDocEncoding::TryConvertUTF8ToPdfDocEncoding(const string_view& view, string& pdfdocencstr)
{
    auto& map = GetUTF8ToPdfEncodingMap();
...
string PdfDocEncoding::ConvertPdfDocEncodingToUTF8(const string_view& view, bool& isUTF8Equal)
{
    string ret;
...
void PdfDocEncoding::ConvertPdfDocEncodingToUTF8(const string_view& view, string& u8str, bool& isUTF8Equal)
{
    u8str.clear();
    isUTF8Equal = true;
    for (size_t i = 0; i < view.length(); i++)
...
const unordered_map<char32_t, char>& PdfDocEncoding::GetUTF8ToPdfEncodingMap()
{
