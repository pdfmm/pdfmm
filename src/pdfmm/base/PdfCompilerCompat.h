...
//
#if defined(__GNUC__)
#  define PDFMM__FUNCTION__ __PRETTY_FUNCTION__
#else
#  define PDFMM__FUNCTION__ __FUNCTION__
#endif

/**
 * \page pdfmm PdfCompilerCompat Header
 * 
 ...
 *
 * If the nasty platform and compiler specific hacks can be kept to pdfmm's
