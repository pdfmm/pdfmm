...
const Base14FontData PoDoFo::CHAR_DATA_COURIER[315] = {
    { 0x0020, 600 },
    { 0x0021, 600 },
    { 0x0022, 600 },
    { 0x0023, 600 },
...
const Base14FontData PoDoFo::CHAR_DATA_COURIER_BOLD[315] = {
    { 0x0020, 600 },
    { 0x0021, 600 },
    { 0x0022, 600 },
    { 0x0023, 600 },
...
const Base14FontData PoDoFo::CHAR_DATA_COURIER_BOLD_OBLIQUE[315] = {
    { 0x0020, 600 },
    { 0x0021, 600 },
    { 0x0022, 600 },
    { 0x0023, 600 },
...
const Base14FontData PoDoFo::CHAR_DATA_COURIER_OBLIQUE[315] = {
    { 0x0020, 600 },
    { 0x0021, 600 },
    { 0x0022, 600 },
    { 0x0023, 600 },
...
const Base14FontData PoDoFo::CHAR_DATA_HELVETICA[315] = {
    { 0x0020, 278 },
    { 0x0021, 278 },
    { 0x0022, 355 },
    { 0x0023, 556 },
...
const Base14FontData PoDoFo::CHAR_DATA_HELVETICA_BOLD[315] = {
    { 0x0020, 278 },
    { 0x0021, 333 },
    { 0x0022, 474 },
    { 0x0023, 556 },
...
const Base14FontData PoDoFo::CHAR_DATA_HELVETICA_BOLD_OBLIQUE[315] = {
    { 0x0020, 278 },
    { 0x0021, 333 },
    { 0x0022, 474 },
    { 0x0023, 556 },
...
const Base14FontData PoDoFo::CHAR_DATA_HELVETICA_OBLIQUE[315] = {
    { 0x0020, 278 },
    { 0x0021, 278 },
    { 0x0022, 355 },
    { 0x0023, 556 },
...
const Base14FontData PoDoFo::CHAR_DATA_TIMES_ROMAN[315] = {
    { 0x0020, 250 },
    { 0x0021, 333 },
    { 0x0022, 408 },
    { 0x0023, 500 },
...
const Base14FontData PoDoFo::CHAR_DATA_TIMES_BOLD[315] = {
    { 0x0020, 250 },
    { 0x0021, 333 },
    { 0x0022, 555 },
    { 0x0023, 500 },
...
const Base14FontData PoDoFo::CHAR_DATA_TIMES_BOLD_ITALIC[315] = {
    { 0x0020, 250 },
    { 0x0021, 389 },
    { 0x0022, 555 },
    { 0x0023, 500 },
...
const Base14FontData PoDoFo::CHAR_DATA_TIMES_ITALIC[315] = {
    { 0x0020, 250 },
    { 0x0021, 333 },
    { 0x0022, 420 },
    { 0x0023, 500 },
...
const Base14FontData PoDoFo::CHAR_DATA_ZAPF_DINGBATS[202] = {
    { 0x0020, 278 },
    { 0x0021, 974 },
    { 0x0022, 961 },
    { 0x0023, 974 },
...
const Base14FontData PoDoFo::CHAR_DATA_SYMBOL[190] = {
    { 0x0020, 250 },
    { 0x0021, 333 },
    { 0x0022, 713 },
    { 0x0023, 500 },
...
string_view PoDoFo::GetStandard14FontName(PdfStd14FontType stdFont)
{
    switch (stdFont)
    {
...
bool PoDoFo::IsStandard14Font(const string_view& fontName, PdfStd14FontType& stdFont)
{
...
const Base14FontData* PoDoFo::GetStd14FontData(PdfStd14FontType stdFont, unsigned& size)
{
    switch (stdFont)
    {
        case PdfStd14FontType::TimesRoman:
...
const Std14CPToGIDMap& PoDoFo::GetStd14CPToGIDMap(PdfStd14FontType stdFont)
{
    switch (stdFont)
    {
        case PdfStd14FontType::TimesRoman:
