...
namespace PoDoFo
{
    ...
    class PODOFO_API PdfDocEncoding final : public PdfPredefinedEncoding
    {
        friend class PdfEncodingMapFactory;
     ...
     */
     // FIX-ME: This shouldn't be a PdfPredefinedEncoding
    class PODOFO_API PdfStandardEncoding final : public PdfPredefinedEncoding
    {
        friend class PdfEncodingMapFactory;
     ...
     */
     // FIX-ME: This shouldn't be a PdfPredefinedEncoding
    class PODOFO_API PdfSymbolEncoding final : public PdfPredefinedEncoding
    {
        friend class PdfEncodingMapFactory;
     ...
     */
     // FIX-ME: This shouldn't be a PdfPredefinedEncoding
    class PODOFO_API PdfZapfDingbatsEncoding final : public PdfPredefinedEncoding
    {
        friend class PdfEncodingMapFactory;
     ...
     */
    // FIX-ME: This shouldn't be a PdfPredefinedEncoding
    class PODOFO_API PdfWin1250Encoding final : public PdfWinAnsiEncoding
    {
        friend class PdfEncodingMapFactory;
     ...
     */
     // FIX-ME: This shouldn't be a PdfPredefinedEncoding
    class PODOFO_API PdfIso88592Encoding final : public PdfWinAnsiEncoding
    {
        friend class PdfEncodingMapFactory;
